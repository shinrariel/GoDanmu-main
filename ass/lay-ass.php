...
<head>
  <meta charset="utf-8">
  <title>GoDanmu 临时审核页面V0.2</title>
...
<body class="layui-layout-body" layadmin-themealias="default">
    ...
    <div class="layui-layout layui-layout-admin">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="console">
                  <a !lay-href="home/homepage1.html">活动控制台</a>
                </dd>
                <dd data-name="console">
                  <a !lay-href="home/homepage2.html">即时通信</a>
                </dd>
              </dl>
            </li>
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                ...
                <dd>
                  <a !lay-href="user/administrators/list.html">超管功能</a>
                </dd>
                <dd>
                  <a !lay-href="user/administrators/role.html">角色管理</a>
                </dd>
                <dd>
                  <a !lay-href="user/administrators/role.html">日志管理</a>
                </dd>
              </dl>
            </li>
            <li data-name="set" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd class="layui-nav-itemed">
                  ...
                  <dl class="layui-nav-child">
                    <dd><a !lay-href="set/system/website.html">全局设置</a></dd>
                    <dd><a !lay-href="set/system/website.html">信号设置</a></dd>
                    <dd><a !lay-href="set/system/website.html">屏蔽词设置</a></dd>
                    <dd><a !lay-href="set/system/website.html">缓存设置</a></dd>
                    <dd><a !lay-href="set/system/website.html">调试设置</a></dd>
                  </dl>
                </dd>
                <dd class="layui-nav-itemed">
                  ...
                  <dl class="layui-nav-child">
                    ...
                    <dd><a !lay-href="set/user/password.html">退出</a></dd>
                  </dl>
                </dd>
              </dl>
            </li>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="assessor.php" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
  ...
  <script>
    layui.config({
      base: '//www.layui.com/admin/std/dist/layuiadmin/' //静态资源所在路径
    }).extend({
